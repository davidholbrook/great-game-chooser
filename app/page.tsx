   ...
   <div className="container mx-auto">
    <h1 className="text-[#fffdfb] text-center font-bold text-3xl pt-14 mb-8">Great Game Chooser</h1>
      <div className="gamelist min-h-[60vh]">
        <h2 className="text-orange-600 font-bold drop-shadow-sm text-3xl pt-5 mb-8 text-center">Your Game List</h2>
        <div className="w-2/3 mx-auto mt-5">
          ...
          <div className="flex justify-center mt-10">
            <button type="button" className="bg-orange-600 py-3 px-5 uppercase font-bold cursor">Choose next game</button>
          </div>
        </div>
      </div>
   </div>
